...
#
# It's also safe to hash only some dependencies (e.g. if you know that some
...
# This perl script replaces the original sed script.
# It concats lines ending with \ then adds $(call hash_deps).
#
...
define hash_deps_in_autogen_dep_file
    $(if $(HASHDEPS_DISABLE),,perl -pi -e 's/\\\n//; s/:(.*)/: \$$(call hash_deps,$$1)/' $(1))
endef
